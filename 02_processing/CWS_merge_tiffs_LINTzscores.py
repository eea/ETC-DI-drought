...
folder_name = 'LINT_anom'  # Folder name (without '_aoi') that contains the AOI-files that should be merged. e.g. 'MRVPP_workflow_results' for SMA and LINT based drought indicators, 'LINT_anom' for lint zscores, etc.
...
out_path = os.path.join(base_path, f'{folder_name}_newbaseline')
